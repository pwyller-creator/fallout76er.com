...
const SPAWN_DATA = {
  ...
  'Critters (Small Game)': [
    { name: 'The Forest Farms',              region: 'The Forest',      count: 'Ambient',       note: 'Chickens, Opossums, and Brahmin wander the homesteads — Flatwoods, the Wayward, Sunnytop. Easy Take a Photo targets that will not fight back.' },
    { name: 'Savage Divide Woods',           region: 'Savage Divide',   count: 'Ambient',       note: 'Squirrels and Foxes dart through the high forests. Quick photo-challenge fauna — tag them with the camera before they scatter.' },
  ...
  'Robobrain': [
    { name: 'RobCo Research Center',          region: 'Cranberry Bog',   count: 'Several',       note: 'A large part of the facility was literally built to manufacture Robobrains — the single most consistent spawn on the map, alongside plenty of other hostile robots.' },
    { name: 'Garrahan Mining Headquarters',   region: 'Ash Heap',        count: 'Several',       note: 'Patrols the lobby and admin floor of the Garrahan family headquarters, south of Lewisburg Station. A solid Ash Heap stop for the Destroy a Robot daily.' },
    { name: 'Dyer Chemical (Sewers)',         region: 'The Mire',        count: 'Several',       note: 'The sewers crawl with Gutsies, Protectrons, Robobrains, and the occasional Sentry Bot — a dense mixed-robot pocket.', map: 'DyerChemical.webp' },
  ],
  'Scorchbeast': [
